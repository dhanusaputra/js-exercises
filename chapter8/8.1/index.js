...
const resolvers = {
  Query: {
    ...
    allBooks: (root, args) => {
      let filteredBooks = args.author ? books.filter(book => book.author === args.author) : books
  ...
  Mutation: {
    ...
    editAuthor: (root, args) => {
      ...
      authors = authors.map(author => author.id === editedAuthor.id ? { ...editedAuthor, born: args.setBornTo } : author)
